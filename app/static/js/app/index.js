...
(function() {
  ...
  window.Projectionable = (function(_super) {
    ...
    function Projectionable() {
      ...
      if (window.sessionID) {
        this.loadData(function() {
          var _ref;
          if ((_ref = window.location.hash) === '' || _ref === '#') {
    ...
    Projectionable.prototype.loadData = function(callback) {
      var accountDeferred, assetDeferred, fileDeferred, permissionDeferred, projectDeferred, reqDeferred, reqGroupDeferred,
        _this = this;
      ...
      Projectionable.Permission.one('refresh', function() {
        return permissionDeferred.resolve();
      });
      ...
      Projectionable.RequirementGroup.one('refresh', function() {
        return reqGroupDeferred.resolve();
      });
      reqDeferred = $.Deferred();
      Projectionable.Requirement.one('refresh', function() {
        return reqDeferred.resolve();
      });
      assetDeferred = $.Deferred();
      Projectionable.ProjectAsset.one('refresh', function() {
        return assetDeferred.resolve();
      });
      fileDeferred = $.Deferred();
      Projectionable.ProjectFile.one('refresh', function() {
      ...
      $.when(accountDeferred, permissionDeferred, reqGroupDeferred, reqDeferred, assetDeferred, fileDeferred).done(function() {
    ...
    Projectionable.prototype.makeModelTemplate = function(pid, idx) {
      if (idx == null) {
        idx = 0;
      }
      return {
    ...
    Projectionable.prototype.makeFieldTemplate = function(mid, idx) {
      if (idx == null) {
        idx = 0;
      }
      return {
  ...
  Navigation = (function(_super) {
    ...
    function Navigation() {
      ...
      this.makeLinkActive = __bind(this.makeLinkActive, this);
      this.el = $('#navigation');
    ...
    Navigation.prototype.makeLinkActive = function(event) {
      if (event.target.tagName.toLowerCase() !== 'a') {
        return;
      }
      return $(event.target).addClass('active').parent().parent().find('> li > a').not(event.target).removeClass('active');
    };

    Navigation.prototype.render = function() {
      this.html(this.view('navigation'));
      return this;
    };
